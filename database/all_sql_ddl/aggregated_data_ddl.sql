...
CREATE TABLE IF NOT EXISTS `index_components_historical_estimations`(
    ...
    `pe_ttm_estimation_overall` DECIMAL(10,5) DEFAULT NULL COMMENT '整体预估滚动市盈率',
    ...
    `dividend_yield_estimation_overall` DECIMAL(10,5) DEFAULT NULL COMMENT '整体预估股息率',
...
CREATE TABLE IF NOT EXISTS `stock_bond_ratio_di`(
	...
	`index_tv` BIGINT NOT NULL COMMENT '指数成交量',
	`index_ta` BIGINT DEFAULT NULL COMMENT '指数成交金额',
	`index_cp` DECIMAL(22,5) NOT NULL COMMENT '指数收盘点位',
	`index_cpc` DECIMAL(26,20) NOT NULL COMMENT '指数涨跌幅',
