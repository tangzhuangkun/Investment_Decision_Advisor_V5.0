...
CREATE TABLE IF NOT EXISTS `index_excellent_performance_indices_di`(
    ...
    `one_year_volatility` DECIMAL(5,2) DEFAULT NULL COMMENT '近1年年化波动率',
	`three_year_volatility` DECIMAL(5,2) DEFAULT NULL COMMENT '近3年年化波动率',
	`five_year_volatility` DECIMAL(5,2) DEFAULT NULL COMMENT '近5年年化波动率',
